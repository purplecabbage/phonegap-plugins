...
{
	Cordova.exec("SAiOSPaypalPlugin.prepare", paymentType);
}
...
{
	Cordova.exec("SAiOSPaypalPlugin.pay");
}
...
{
	Cordova.exec("SAiOSPaypalPlugin.setPaymentInfo", paymentProperties);
}
 ...
 */
Cordova.addConstructor(SAiOSPaypalPlugin.install);