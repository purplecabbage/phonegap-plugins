...
{
    //id pins = [[JSONDecoder decoder] objectWithData:[arguments objectAtIndex:0]];
    //NSAssert([pins isKindOfClass:NSDictionary.class], @"JSON parsing to NSDictionary failed.");     
    ...
    //NSString *string = [pins objectForKey:@"someJSONKey"];
