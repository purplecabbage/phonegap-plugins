...
Globalization.prototype.getLocaleName = function(successCB, failureCB)
{
	...
	PhoneGap.exec(successCB, failureCB, "Globalization","getLocaleName", []);
};
...
Globalization.prototype.dateToString = function(date, successCB, failureCB, options)
{
	...
	if (date instanceof Date){
		...
		PhoneGap.exec(successCB, failureCB, "Globalization", "dateToString", [{"date": dateValue, "options": options}]);
	}
	else {
...
Globalization.prototype.stringToDate = function(dateString, successCB, failureCB, options)
{
	...
	if (typeof dateString == "string"){
		PhoneGap.exec(successCB, failureCB, "Globalization", "stringToDate", [{"dateString": dateString, "options": options}]);
	}
	else {
...
Globalization.prototype.getDatePattern = function(successCB, failureCB, options)
{
	...
	PhoneGap.exec(successCB, failureCB, "Globalization", "getDatePattern", [{"options": options}]);
};
...
Globalization.prototype.getDateNames = function(successCB, failureCB, options)
{
	...
	PhoneGap.exec(successCB, failureCB, "Globalization", "getDateNames", [{"options": options}]);
};
...
Globalization.prototype.isDayLightSavingsTime = function(date, successCB, failureCB)
{
	...
	if (date instanceof Date){
		var dateValue;
		dateValue = date.valueOf();
		PhoneGap.exec(successCB, failureCB, "Globalization", "isDayLightSavingsTime", [{"date": dateValue}]);
	}
	else {
...
Globalization.prototype.getFirstDayOfWeek = function(successCB, failureCB)
{
	...
	PhoneGap.exec(successCB, failureCB, "Globalization", "getFirstDayOfWeek", []);
};
...
Globalization.prototype.numberToString = function(number, successCB, failureCB, options)
{
	...
	if(typeof number == "number") {
		PhoneGap.exec(successCB, failureCB, "Globalization", "numberToString", [{"number": number, "options": options}]);
	}
	else {
...
Globalization.prototype.stringToNumber = function(numberString, successCB, failureCB, options)
{
	...
	if(typeof numberString == "string") {
		PhoneGap.exec(successCB, failureCB, "Globalization", "stringToNumber", [{"numberString": numberString, "options": options}]);
	}
	else {
...
Globalization.prototype.getNumberPattern = function(successCB, failureCB, options)
{
	...
	PhoneGap.exec(successCB, failureCB, "Globalization", "getNumberPattern", [{"options": options}]);	
};
...
Globalization.prototype.getCurrencyPattern = function(currencyCode, successCB, failureCB)
{
	...
	if(typeof currencyCode == "string") {
		PhoneGap.exec(successCB, failureCB, "Globalization", "getCurrencyPattern", [{"currencyCode": currencyCode}]);
	}
	else {
...
PhoneGap.addConstructor(Globalization.install);
};