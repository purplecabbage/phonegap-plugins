...
- (void) getLocaleName:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options
{
	...
	if(locale) {
		...
		result = [PluginResult resultWithStatus:PGCommandStatus_ERROR messageAsInt: UNKNOWN_ERROR];
...
- (void) dateToString:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options
{
	...
	// error
		...
		result = [PluginResult resultWithStatus:PGCommandStatus_ERROR messageAsInt: FORMATTING_ERROR];
		jsString = [result toErrorCallbackString:callBackId];
	}
...
- (void) stringToDate:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options
{
	...
	// error
		...
		result = [PluginResult resultWithStatus:PGCommandStatus_ERROR messageAsInt: PARSING_ERROR];
		jsString = [result toErrorCallbackString:callBackId];
	}
...
- (void) getDatePattern:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options
{
	...
	// error
		...
		result = [PluginResult resultWithStatus:PGCommandStatus_ERROR messageAsInt: PATTERN_ERROR];
		jsString = [result toErrorCallbackString:callBackId];
	}
