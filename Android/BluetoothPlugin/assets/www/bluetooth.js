...
cordova.define("cordova/plugin/bluetooth", function(require, exports, module) {
	...
	Bluetooth.prototype.write = function(successCallback,failureCallback,socketid, msg) {
	    return exec(successCallback, failureCallback, 'BluetoothPlugin', 'write', [socketid, msg]);
	}
