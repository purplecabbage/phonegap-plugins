Tests.prototype.GlobalizationTests = function() {
    ...
    // use these variables to hold the formatted string results that we will later use during parsing
    ...
    test("dateToString using formatLength=medium and selector=date and time(default) options, success callback should be called with a Properties object", function() {
         expect(4);
         QUnit.stop(Tests.TEST_TIMEOUT);
         var win = function(a) {
            ok(typeof a == 'object', "Properties object returned in dateToString success callback should be of type 'object'.");
         ...
         var fail = function() { start(); };
         window.plugins.globalization.dateToString(new Date(), win, fail, {formatLength: 'medium'});
    });
    test("dateToString using formatLength=long and selector=date and time(default) options, success callback should be called with a Properties object", function() {
         expect(4);
         QUnit.stop(Tests.TEST_TIMEOUT);
         var win = function(a) {
            ok(typeof a == 'object', "Properties object returned in dateToString success callback should be of type 'object'.");
         ...
         var fail = function() { start(); };
         window.plugins.globalization.dateToString(new Date(), win, fail, {formatLength: 'long'});
    });
    test("dateToString using formatLength=full and selector=date and time(default) options, success callback should be called with a Properties object", function() {
         expect(4);
         QUnit.stop(Tests.TEST_TIMEOUT);
         var win = function(a) {
            ok(typeof a == 'object', "Properties object returned in dateToString success callback should be of type 'object'.");
         ...
         var fail = function() { start(); };
         window.plugins.globalization.dateToString(new Date(), win, fail, {formatLength: 'full'});
    });
    ...
    test("stringToDate using default options, success callback should be called with a Properties object", function() {
         ...
         var fail = function() { start(); };
         window.plugins.globalization.stringToDate("Tuesday, March 03, 2011 03:03:03am", win, fail);
    });
    ...
    test("getDateNames using type=narrow and item=months options, success callback should be called with a Properties object", function() {
         expect(5);
         QUnit.stop(Tests.TEST_TIMEOUT);
         var win = function(a) {
            ok(typeof a == 'object', "Properties object returned in getDateNames success callback should be of type 'object'.");
         ...
         var fail = function() { start(); };
         window.plugins.globalization.getDateNames(win, fail, {type: 'narrow'});
    });
    test("getDateNames using type=wide and item=days options, success callback should be called with a Properties object", function() {
         expect(5);
         QUnit.stop(Tests.TEST_TIMEOUT);
         var win = function(a) {
            ok(typeof a == 'object', "Properties object returned in getDateNames success callback should be of type 'object'.");
         ...
         var fail = function() { start(); };
         window.plugins.globalization.getDateNames(win, fail, {item: 'days'});
    });
    ...
    test("numberToString using type=currency options, success callback should be called with a Properties object", function() {
         expect(4);
         QUnit.stop(Tests.TEST_TIMEOUT);
         var win = function(a) {
            ok(typeof a == 'object', "Properties object returned in numberToString success callback should be of type 'object'.");
            ...
            ok(typeof a.value == 'string', "Properties object's 'value' property returned in numberToString success callback should be of type 'string'.");
            ok(a.value.length > 0, "Properties object's 'value' property returned in numberToString success callback should have an length greater than 0.");
            formattedCurrencyNumber = a.value;
            start();
         };
         var fail = function() { start(); };
         window.plugins.globalization.numberToString(5.20, win, fail, {type: 'currency'});
    });
    ...
    test("stringToNumber using type=currency options, success callback should be called with a Properties object", function() {
         expect(4);
         QUnit.stop(Tests.TEST_TIMEOUT);
         var win = function(a) {
            ok(typeof a == 'object', "Properties object returned in stringToNumber success callback should be of type 'object'.");
         ...
         var fail = function() { start(); };
         window.plugins.globalization.stringToNumber(formattedCurrencyNumber, win, fail, {type: 'currency'});
    });
    ...
    test("getNumberPattern using type=currency options, success callback should be called with a Properties object", function() {
         expect(15);
         QUnit.stop(Tests.TEST_TIMEOUT);
         var win = function(a) {
            ok(typeof a == 'object', "Properties object returned in getNumberPattern success callback should be of type 'object'.");
         ...
         var fail = function() {start(); };
         window.plugins.globalization.getNumberPattern(win, fail, {type: 'currency'});
    });
